...
session_start();
        ...
        if(!$con)
       {
           die('not connected');
            ...
            $con=  mysqli_query($con, "select * from tbl_tname");
		...
		<ul class="list-group"> 
		 ...
		 <thead>
		  ...
		  <?php
			...
			echo "<td><a href=\"tedit.php?id=$row[id]\">Edit</a> | <a href=\"tdelete.php?id=$row[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";        
        }
        ?>
		 ...
		 <form name = "form3" action= "addtname.php"   method= "POST">
		 <table class="table responsive">
		 <table id= "team_data" class = "table table-bordered">
		 <thead>
		  <tr>
		  <td><input type="text1" placeholder="Enter Team Name" name="tname"></td>
		  <td> <button type="submit" class="btn btn-primary btn-sm"> Create New Team </button></td>
		  </tr>
		  </thead>
		  </form>
		 </table>
